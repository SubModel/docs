...
开始之前,先了解如何[选择 Pod](https://github.com/SubModel/docs/tree/main/pods/choose-a-pod.md),然后参照[管理 Pod](https://github.com/SubModel/docs/tree/main/pods/manage-pods.md) 指南操作。

## 了解更多

你可以使用 Template 快速启动一个正在运行的 Pod。若需进一步定制,可配置以下设置:

* [GPU 类型](https://github.com/SubModel/docs/tree/main/references/gpu-types.md)与数量
* 系统磁盘大小
* 启动命令
* [环境变量](https://github.com/SubModel/docs/tree/main/pods/references/environment-variables.md)
* [暴露 HTTP/TCP port](https://github.com/SubModel/docs/tree/main/pods/configuration/expose-ports.md)
* [持久化存储选项](https://github.com/SubModel/docs/tree/main/pods/storage/types.md)

开始时,请参阅如何[选择 Pod](https://github.com/SubModel/docs/tree/main/pods/choose-a-pod.md),并参考[管理 Pod](https://github.com/SubModel/docs/tree/main/pods/manage-pods.md) 指南。
