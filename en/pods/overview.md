...
To get started, check out how to [Choose a Pod](choose-a-pod.md), then follow the guide on [Managing Pods](manage-pods.md).
...
* [Exposing HTTP/TCP Ports](configuration/expose-ports.md)
* [Persistent Storage Options](storage/types.md)

To begin, see how to [Choose a Pod](choose-a-pod.md) and refer to the guide on [Managing Pods](manage-pods.md).
