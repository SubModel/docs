...
For more information on sending requests, refer to [Send a Request](send-requests.md).
...
For reference information on Endpoints, see [Endpoint Operations](../references/operations.md).
