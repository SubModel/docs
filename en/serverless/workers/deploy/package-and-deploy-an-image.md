...
> **Note**\
> For deploying large language models (LLMs), you can use the [Configurable Endpoints](https://github.com/SubModel/docs/blob/main/serverless/workers/vllm/configurable-endpoints.md) feature instead of working directly with Docker.\
...
_Unfamiliar with Docker? Check out Docker's_ [_overview page_](https://docs.docker.com/get-started/overview/)_._
...
To build and push the image, review the steps in [Get started](../overview.md).
