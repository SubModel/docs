...
| Parameter                       | Type                  | Default Value | Description                                                                                                                                                                                                                                                                            |
| ------------------------------- | --------------------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `best_of`                       | Optional\[int]        | None          | Number of output sequences that are generated from the prompt. From these `best_of` sequences, the top `极sequences are returned.` best\_of`must be greater than or equal to`n`. This is treated as the beam width when` use\_beam\_search`is True. By default,`best\_of`is set to`n\`. |
