...
You can also utilize SubModel's [`input` request format](https://github.com/SubModel/docs/blob/main/serverless/endpoints/send-requests/README.md).
...
For detailed guidance on setting up, configuring, and deploying your vLLM Serverless Endpoint Worker, including compatibility details, environment variable settings, and usage examples, see [Get Started](https://github.com/SubModel/docs/blob/main/serverless/workers/vllm-endpoint/get-started/README.md).

### Deployment Options

* [**Configurable Endpoints**](https://github.com/SubModel/docs/blob/main/serverless/workers/vllm-endpoint/get-started/README.md#deploy-using-the-web-ui): (Recommended) Use SubModel's Web UI to quickly deploy the OpenAI-compatible LLM with the vLLM Worker.
* [**Pre-Built Docker Image**](https://github.com/SubModel/docs/blob/main/serverless/workers/vllm-endpoint/get-started/README.md#deploy-using-the-worker-image): Leverage a pre-configured Docker image for hassle-free deployment. Ideal for users seeking a quick and straightforward setup process.
...
* [Get Started](https://github.com/SubModel/docs/blob/main/serverless/workers/vllm-endpoint/get-started/README.md): Learn how to deploy a vLLM Worker as a Serverless Endpoint, with detailed guides on configuration and sending requests.
* [Configurable Endpoints](https://github.com/SubModel/docs/blob/main/serverless/workers/vllm-endpoint/configurable-endpoints/README.md): Select your Hugging Face model and let vLLM handle the low-level details of model loading, hardware configuration, and execution.
* [Environment Variables](https://github.com/SubModel/docs/blob/main/serverless/workers/vllm-endpoint/environment-variables/README.md): Explore the environment variables available for the vLLM Worker, including detailed documentation and examples.
* [Run Gemma 7b](https://github.com/SubModel/docs/blob/main/tutorials/serverless/gpu/run-gemma-7b/README.md): Walk through deploying Google's Gemma model using SubModel's vLLM Worker, guiding you to set up a Serverless Endpoint with a gated large language model (LLM).
