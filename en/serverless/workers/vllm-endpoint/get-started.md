...
Once the Endpoint initializes, you can start sending requests to your [Endpoint](../../endpoints/get-started.md). Proceed to the [Send a Request](get-started.md#sending-a-request) section for further instructions.
...
3. Provide the following details:
   ...
   * (Optional) Attach a [network storage volume](https://github.com/SubModel/docs/blob/main/serverless/endpoints/manage-endpoints/README.md#add-a-network-volume)
...
Once the Endpoint initializes, you can start sending requests to your [Endpoint](https://github.com/SubModel/docs/blob/main/serverless/endpoints/get-started/README.md). Proceed to the [Send a Request](get-started.md#sending-a-request) section for further instructions.

For a complete list of available environment variables, refer to the [vLLM Worker variables](https://github.com/SubModel/docs/blob/main/serverless/workers/vllm-endpoint/environment-variables/README.md) documentation.
...
| `batch_size_growth_factor` | `int`                  | env var `DEFAULT_BATCH_SIZE_GROWTH_FACTOR` | The growth factor by which min\_batch\_size will be multiplied for each call until max\_batch\_size is reached. |
...
For more information on managing your Serverless Endpoints, refer to the [Manage Endpoints](https://github.com/SubModel/docs/blob/main/serverless/endpoints/manage-endpoints/README.md) guide. For a complete reference of the vLLM Worker environment variables, see the [vLLM Worker variables](https://github.com/SubModel/docs/blob/main/serverless/workers/vllm-endpoint/environment-variables/README.md) documentation.
