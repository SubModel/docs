...
_Note: If users (B2B users only) need to recharge using Bank transfer, they can sign a contract with us and make a public-to-public transfer. We will recharge the user’s account through the backend._
...
**Business Cooperation Matchmaking Email**： 📧 [business@submodel.ai](mailto:business@submodel.ai)
