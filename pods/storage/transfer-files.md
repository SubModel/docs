...
- 如果你打算使用 `scp`,请确保你的 Pod 已配置为使用真正的 SSH。更多信息,请参见 [使用 SSH](/pods/configuration/use-ssh.md)。
...
> **注意**
> 如果你的私钥文件不在 `~/.ssh/id_ed25519`,或者你使用的是 Windows 命令提示符,请在命令中相应地更新该路径。
...
> **注意**
> 你的本地机器必须运行 Linux 或 [WSL 实例](https://learn.microsoft.com/en-us/windows/wsl/about),才能使用 rsync。
